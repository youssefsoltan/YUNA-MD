...
this.sendButton(id, wm, text, apii.data, [[(action == 'add' ? lenguajeGB.smsCont13() : lenguajeGB.smsCont14()), (action == 'add' ? '.s' : '.s')], ['💖 قائمة الأوامر ', `.menu`]], null, {mentions: this.parseMention(text)})
